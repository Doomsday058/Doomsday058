...
* **[B2B веб-сервис для оптовой торговли (ТОО «VOSTOK TRADE COMPANY»)](https://github.com/Doomsday058/vostok_trade_frontend):** разработал full-stack приложение на стеке **Next.js** (фронтенд) и **Node.js/Express** (бэкенд) с базой данных **MongoDB**. Реализовал аутентификацию, личный кабинет и автоматическую отправку прайс-листов на email.
