...
* **Интеллектуальный кинематографический сервис "FilmAdviser":** full-stack проект на стеке **React** (фронтенд) и **Flask/Node.js** (бэкенд). Сервис не только ищет фильмы, но и формирует уникальные краткие обзоры с помощью нейросетей.
    <br> **[⚙️ Посмотреть репозиторий проекта](https://github.com/Doomsday058/online-cinema-frontend)**
