...
Единственный аналитик направления внутренних систем: интеграционный контур вокруг медицинской информационной системы и внутренние сервисы компании. Веду задачи от выявления требований до внедрения и сопровождения.
